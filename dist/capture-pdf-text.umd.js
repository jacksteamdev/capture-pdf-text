...
var searchTrees$1 = fp.curry(searchTrees);
...
const createItemTrees = main(['left', 'right', 'bottom', 'top']);
...
const groupTextItems = (universe, { selection }) => {
  ...
  const bodyItems = searchUniverse(fp.intersection, selection);
